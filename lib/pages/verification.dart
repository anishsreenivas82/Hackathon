    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
          ...
          children: [
            ...
            Row(children: [
              Container(child: Wrap(children: [Text('Are the products sealed?')]),width: width*0.6),
              Radio(
                  value: 1,
                  groupValue: radio1,
                  onChanged: (value) {
            ...
            Row(children: [
              Container(child: Wrap(children: [Text('Do the products have atleast 2 weeks before expiry')]),width: width*0.6),
              Radio(
                  value: 2,
                  groupValue: radio2,
                  onChanged: (value) {
            ...
            Row(children: [
              Container(child: Wrap(children: [Text('Do the products match the description above')]),width: width*0.6),
              Radio(
                  value: 3,
                  groupValue: radio3,
                  onChanged: (value) {
            ...
            Row(children: [
              TextButton(onPressed: (){ a.doc('donations').collection('donations').doc(doc).set({
                  'Name': name,
                  'Type': type,
                  'Quantity': quantity,
                  'Baby': babyproduct,
