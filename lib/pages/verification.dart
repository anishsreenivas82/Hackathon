                ...
                Row(
                  ...
                  children: [
                    Container(
                        child: Wrap(children: [
                          Text(
                            'Do the products have atleast 2 weeks before expiry?',
                            style: TextStyle(fontSize: 18),
                          )
                        ]),
                        width: width * 0.8),
                ...
                Row(
                  ...
                  children: [
                    Container(
                        child: Wrap(children: [
                          Text(
                            'Do the products match the description above?',
                            style: TextStyle(fontSize: 18),
                          )
                        ]),
                        width: width * 0.8),
                  ...
                  children: [
                        ...
                        onPressed: () {
                          if (i >= 3) {
                            ...
                            Fluttertoast.showToast(
                                msg: "The product cannot be accepted",
                    ...
                    TextButton(
                        onPressed: () {
                          if (i >= 3) {
                            Fluttertoast.showToast(
                                msg: 'The product cannot be rejected',
                                toastLength: Toast.LENGTH_LONG,
                                gravity: ToastGravity.BOTTOM,
                                timeInSecForIosWeb: 1,
                                backgroundColor: Colors.red,
